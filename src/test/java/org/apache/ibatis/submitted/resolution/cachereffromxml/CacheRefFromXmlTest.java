...
class CacheRefFromXmlTest {
  ...
  @Test
  void shouldGetAUser() throws IOException, SQLException {
    Reader reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/resolution/cachereffromxml/mybatis-config.xml");
